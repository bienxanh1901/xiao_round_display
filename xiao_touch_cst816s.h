 ...
 *      - ESP_OK: on success
 */
esp_err_t xiao_touch_new_i2c_cst816s(const esp_lcd_panel_io_handle_t io, const esp_lcd_touch_config_t *config, esp_lcd_touch_handle_t *tp);

/**
 * @brief I2C address of the CST816S controller
 *
 */
#define XIAO_TOUCH_IO_I2C_CST816S_ADDRESS    (0x2E)
...
#define XIAO_TOUCH_IO_I2C_CST816S_CONFIG()             \
    {                                                    \
        .dev_addr = XIAO_TOUCH_IO_I2C_CST816S_ADDRESS, \
